    ...
    <div class="row">
        <div class="col-12">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form action="/dashboard/tv_show/" method="post" enctype="multipart/form-data" class="needs-validation">
                        @csrf
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input @error('poster') is-invalid @enderror" id="poster" name="poster">
                                ...
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input @error('sampul') is-invalid @enderror" id="sampul" name="sampul">
